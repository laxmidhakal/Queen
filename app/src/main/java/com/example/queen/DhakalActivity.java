...
public class DhakalActivity extends AppCompatActivity {
    ImageView binita;
    Button bini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhakal);
        ...
        Cursor cursor=database.rawQuery("SELECT DESCRIPTION,RUPI,TOTAL FROM PRODUCTS",new String[]{});
        if(cursor !=null){
            cursor.moveToFirst();
